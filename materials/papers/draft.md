...
# 4. 実験環境
## 4.1 汎用性検証のための対象選定
本研究では、Ferencらが構築したBugHunterデータセット\cite{ferenc2020}を基盤として使用する。このデータセットは、GitHubでホストされている15のJavaプロジェクトから自動的に収集されたバグ情報と、各コミットにおけるソースコード要素（ファイル、クラス、メソッド）のメトリクスを含んでいる。
