...
def main():
    ...
    input_path = base_dir + "method-p_add_method_level_metrics.csv"
    output_path = base_dir + "method-p_add_method_commit_level_metrics.csv"
    repo_path = "/Users/nagutabby/orientdb/"
    max_records = 5000
